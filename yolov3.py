...
if __name__ == "__main__":
    ...
    yolov3.save('model/yolov3.h5')
    yolov3_tiny = load_model('model/yolov3-tiny.h5')
    ...
    for fn in os.listdir(img_path):
        photo_filename = os.path.join(img_path, fn)
    ...
    photo_filename = 'imgs/example/street.jpg'
    ...
    candidate_layers = [0, 4, 8, 12, 16, 20, 28, 31]
